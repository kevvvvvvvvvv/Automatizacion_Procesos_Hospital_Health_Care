...
'session.http_only','session.same_site','session.partitioned','laravel-pdf.browsershot.node_binary','laravel-pdf.browsershot.npm_binary',
...
'laravel-pdf.browsershot.write_options_to_file','laravel-pdf.browsershot.no_sandbox','ide-helper.filename','ide-helper.models_filename','ide-helper.meta_filename',
...
'sanctum.csrf-cookie','home','dashboard','cargos.store',
'habitaciones.index','habitaciones.create','habitaciones.store','habitaciones.show','habitaciones.edit',
'habitaciones.update','habitaciones.destroy','producto-servicios.index','producto-servicios.create','producto-servicios.store',
'producto-servicios.show','producto-servicios.edit','producto-servicios.update','producto-servicios.destroy','pacientes.index',
'pacientes.create','pacientes.store','pacientes.show','pacientes.edit','pacientes.update',
'pacientes.destroy','doctores.index','doctores.create','doctores.store','doctores.show',
'doctores.edit','doctores.update','doctores.destroy','pacientes.responsable.index','pacientes.responsable.create',
...
'pacientes.estancias.ventas.detallesventas.index','pacientes.estancias.ventas.detallesventas.create','pacientes.estancias.ventas.detallesventas.store','detallesventas.show','detallesventas.edit',
'detallesventas.update','detallesventas.destroy','hojasterapiasiv.store','hojasterapiasiv.update','hojasmedicamentos.store',
'hojasmedicamentos.update','hojassignos.store','hojassondascateters.store','pacientes.estancias.interconsultas.index','pacientes.estancias.interconsultas.create',
...
'pacientes.estancias.interconsultas.honorarios.create','pacientes.estancias.interconsultas.honorarios.store','pacientes.estancias.interconsultas.honorarios.index','honorarios.show','honorarios.edit',
'honorarios.update','honorarios.destroy','doctores.update','hojasfrontales.pdf','hojasfrontales.pdf',
'interconsultas.pdf','hojasenfermerias.pdf','farmacia.solicitud.show','medicamentos.actualizar-estado','notifications.mark-all-as-read','profile.edit','profile.update','profile.destroy','password.edit',
...
'app','header','pdfs.historia-clinica','pdfs.hoja_frontal','pdfs.interconsultas',
'test','laravel-exceptions-renderer::components.badge','laravel-exceptions-renderer::components.empty-state','laravel-exceptions-renderer::components.file-with-line','laravel-exceptions-renderer::components.formatted-source',
