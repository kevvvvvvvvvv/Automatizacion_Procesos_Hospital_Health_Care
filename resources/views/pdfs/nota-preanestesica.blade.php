...
<head>
    <meta charset="UTF-8">
    <title>Nota preanestésica</title>
    <style>
        @page {
            size: A4;
            margin-top: 5cm;
...
<body>
    ...
    <div class="section-content">
        <p><strong>Plan de estudio y/o Tratamiento (indicaciones médicas, vía, dosis, periodicidad): </strong>{{$notaData->plan_estudios_tratamiento}}</p>
        <p><strong>Evaluación clínica del paciente: </strong>{{$notaData->evaluacion_clinica}}</p>
        <p><strong>Plan anestésico, de acuerdo con las condiciones del paciente y la intervención quirúrgica planeada: </strong>{{$notaData->plan_anestesico}}</p>
        <p><strong>Valoración de riesgos: </strong>{{$notaData->valoracion_riesgos}}</p>
        <p><strong>Indicaciones y recomendaciones del servicio de anestesiología: </strong>{{$notaData->indicaciones_recomendaciones}}</p>
    </div>
