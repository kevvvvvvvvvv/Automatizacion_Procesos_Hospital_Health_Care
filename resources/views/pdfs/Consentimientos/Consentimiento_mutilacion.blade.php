...
<head>
    <meta charset="UTF-8">
    <title>Consentimiento Informado Cualquier procedimiento que entrañe mutilación</title>
    <style>
        @page {
            size: A4;
            margin-top: 5cm;
...
<body>
    <main>
        <h1>Consentimiento informado Cualquier procedimiento que entrañe mutilación</h1> 
