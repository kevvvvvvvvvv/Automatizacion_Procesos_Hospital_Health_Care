...
import { Estancia, Paciente, notasEgresos } from '@/types';
...
export const EgresoForm = ({
    ...
    const form = useForm ({
         motivo_egreso: egreso?.motivo_egreso || '',             
          motivo_egreso_otro: egreso?.motivo_egreso || '',  
          diagnosticos_finales: egreso?.diagnosticos_finales || '',  
          resumen_evolucion_estado_actual: egreso?.resumen_evolucion_estado_actual || '',
          manejo_durante_estancia: egreso?.manejo_durante_estancia || '',
          problemas_pendientes: egreso?.problemas_pendientes || '',
          plan_manejo_tratamiento: egreso?.plan_manejo_tratamiento || '',
          recomendaciones: egreso?.recomendaciones || '',
          factores_riesgo: egreso?.factores_riesgo || '',
          pronostico: egreso?.pronostico || '',
          defuncion: egreso?.defuncion || '',
    });
