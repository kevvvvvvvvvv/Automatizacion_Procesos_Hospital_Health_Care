...
class CatalogoPreguntaSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        CatalogoPregunta::create([
            ...
            'tipo_pregunta' => 'direct_multiple', 'permite_desconozco' => false, 'opciones_respuesta' => null,
        ...
        CatalogoPregunta::create([
            ...
            'tipo_pregunta' => 'direct_select', 'permite_desconozco' => false, 'opciones_respuesta' => null,
        ...
        CatalogoPregunta::create([
            ...
            'tipo_pregunta' => 'direct_multiple', 'permite_desconozco' => false, 'opciones_respuesta' => null,
            'campos_adicionales' => [['name' => 'fecha', 'label' => 'Fecha (o marcar si se desconoce)', 'type' => 'month_unknown']]
        ]);
        CatalogoPregunta::create([
            'pregunta' => 'Fecha de Último Papanicolaou', 'orden' => 35, 'categoria' => 'gineco_obstetrico', 'formulario_catalogo_id' => 2,
            'tipo_pregunta' => 'multiple_campos', 'permite_desconozco' => false, 'opciones_respuesta' => null,
            'campos_adicionales' => [['name' => 'fecha', 'label' => 'Fecha (o marcar si se desconoce)', 'type' => 'month_unknown'], ['name' => 'alteraciones', 'label' => 'Alteraciones', 'type' => 'text']]
        ]);
        CatalogoPregunta::create([
